package de.hype.hypenotify.skyblockconstants;

import java.util.Arrays;
import java.util.HashSet;
import java.util.Set;

public interface SBCollections {
    Set<SBCollections> values = values();

    static Set<SBCollections> values() {
        Set<SBCollections> collections = new HashSet<>();
    ...
    static String getCodeReference(String goalName) {
        ...
        for (SBCollections value : values()) {
    ...
    enum Farming implements SBCollections {
    ...
    enum Mining implements SBCollections {
    ...
    enum Combat implements SBCollections {
    ...
    enum Foraging implements SBCollections {
    ...
    enum Fishing implements SBCollections {
    ...
    enum Rift implements SBCollections {
